...
br();
addButtons("clickButtons", ...[new pageButton("Download", "slycodger-CollisionSystem.rar", true), new pageButton("Git", "https://github.com/Slycodger/CollisionTest/tree/slycodger")]);
br();
br();
...
addText("bigText", "I just looked through and fount out this is an old version of it.  I no longer have the project anymore.  Very sucky that this happened, but also not much of a worry because all the code was bad and needed a good redoing.", "p");
